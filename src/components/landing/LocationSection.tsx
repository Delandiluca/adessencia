      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            {/* Address */}
            <div>
              <p className="font-body font-semibold text-xs tracking-widest uppercase mb-3" style={{ color: '#c9973a' }}>
                Local do Evento
              </p>
            ...
            >
              ...
              <p className="font-body text-sm mt-1" style={{ color: '#c9973a' }}>5 de Abril de 2026 · A partir das 06:00</p>
            </div>
          </div>
        </div>
      </div>
